...
//Trap Doors
		...
		addTrapDoor(TFCItems.electrumSheet, 21);
		addTrapDoor(TFCItems.cupronickelSheet, 22);
		addTrapDoor(TFCItems.osmiumSheet, 23);
		addTrapDoor(TFCItems.aluminumSheet, 24);
		addTrapDoor(TFCItems.tungstenSheet, 25);
